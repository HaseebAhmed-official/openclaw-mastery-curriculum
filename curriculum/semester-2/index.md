...
| 3 | Configuration architecture | Navigate config schema, plugin-owned config, control-plane settings, and environment ownership boundaries | Schema, config, and dotenv-boundary drill | Config review |
